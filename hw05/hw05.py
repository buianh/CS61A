...
class VendingMachine:
    ...
    def vend(self):
        ...
        if self.stock == 0:
            ...
            self.difference = self.price - self.balance
            return 'You must add ${0} more funds.'.format(self.difference)
        else:
            self.difference = self.balance - self.price 
            self.stock = self.stock-1
            self.balance = 0
            return 'Here is your {0} and ${1} change.'.format(self.product,self.difference)
